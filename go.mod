module github.com/giantswarm/giantswarm-e2e-tests
...
replace (
	k8s.io/apimachinery v0.26.0 => k8s.io/apimachinery v0.25.0
	k8s.io/client-go v0.26.0 => k8s.io/client-go v0.25.0
)
